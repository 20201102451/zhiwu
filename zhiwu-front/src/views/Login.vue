<template>
  <div class="login">
    <div class="mylogin" align="center">
      ...
      <el-form v-if="userType === 0" :model="loginForm" :rules="loginRules" ref="loginForm" label-width="0px">
        <el-form-item label="" prop="account" style="margin-top: 10px">
          <el-row>
            ...
            <el-col :span="22">
              <el-input class="inps" placeholder="学号" v-model="loginForm.studentId"
        ...
        <el-form-item label="" prop="passWord">
          <el-row>
            ...
            <el-col :span="22">
              <el-input class="inps" type="password" placeholder="密码" v-model="loginForm.userPassword"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
      ...
      <!--      管理员-->
      <el-form v-if="userType === 1" :model="loginForm" ref="loginForm" label-width="0px">
        <el-form-item label="" prop="account" style="margin-top: 10px">
          <el-row>
            <el-col :span="2">
              <span class="el-icon-s-custom"></span>
            ...
            <el-col :span="22">
              <el-input class="inps" placeholder="管理员ID" v-model="loginForm.adminId"
                oninput="value=value.replace(/[^\d.]/g,'')">
              </el-input>
            </el-col>
          </el-row>
        ...
        <el-form-item label="" prop="passWord">
          <el-row>
            ...
            <el-col :span="22">
              <el-input class="inps" type="password" placeholder="密码" v-model="loginForm.adminPassword"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item style="margin-top: 55px">
